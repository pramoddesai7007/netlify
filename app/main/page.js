...
// //         try {
// //             const response = await axios.get(`http://localhost:5000/api/main/${mainCategory._id}`);
...
// //         try {
// //             const response = await axios.delete(`http://localhost:5000/api/main/${menu._id}`);
...
// //             const response = await axios.patch(`http://localhost:5000/api/main/${editedMenu._id}`, formData, {
// //                 headers: {
// //                     'Content-Type': 'multipart/form-data',
// //                 },
// //             });
